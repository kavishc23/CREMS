...
export function AssetsPage({ userRoles }: { userRoles: string[] }) {
  ...
  return <Box sx={{
    ...
    maxWidth: 1500,
    mx: 'auto',
    ...(isDemoMode && { '& button:has([data-testid="QrCode2OutlinedIcon"])': { display: 'none' } }),
  }}>
    ...
    {!isDemoMode && <AssetQrLabelDialog asset={qrAsset} open={Boolean(qrAsset)} onClose={() => setQrAsset(null)} />}
