...
function PageHeader() {
  return <Stack direction="row" gap={1.5} alignItems="center" sx={{ px: { xs: 2, sm: 3, lg: 4 }, pt: 3, pb: 2 }}><ManageAccountsOutlined /><Box><Typography variant="h4" fontWeight={800}>Staff access & activity</Typography><Typography color="text.secondary">Manage staff accounts, operating scope, security and role permissions.</Typography></Box></Stack>
}
