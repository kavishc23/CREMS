...
const navigation = [
  ...
  { label: 'Availability', id: 'availability', icon: <EventAvailableOutlined />, section: 'Rental operations' },
  ...
  { label: 'Operations centre', id: 'operations', icon: <CorporateFareOutlined />, section: 'Management' },
...
const pageHelp: Record<string, { purpose: string; steps: string[] }> = {
  ...
  operations: { purpose: 'Manage daily work and review manager-level approvals in one operations workspace.', steps: ['Start with today’s work.', 'Open Approvals when a manager decision is required.', 'Use Business tools only for supporting operational records.'] },
